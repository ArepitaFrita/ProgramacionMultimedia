...
public final class FragmentMyListBinding implements ViewBinding {
  ...
  private FragmentMyListBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recyclerList) {
  ...
  public static FragmentMyListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyListBinding((FrameLayout) rootView, recyclerList);
    }

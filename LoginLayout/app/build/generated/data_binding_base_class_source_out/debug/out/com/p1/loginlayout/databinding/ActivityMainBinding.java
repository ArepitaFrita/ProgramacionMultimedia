...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSignIn,
      @NonNull TextView textView, @NonNull EditText txtPassword, @NonNull EditText txtUserName) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnSignIn, textView, txtPassword,
          txtUserName);
    }
